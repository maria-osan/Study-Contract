...
void serviceGUImodel::initGUI()
{
    ...
    stgLy->addWidget(listV);
    listV->setModel(listModel);
...
void serviceGUImodel::initConnect()
{
...
void serviceGUImodel::reloadData(const std::vector<Disciplina>& dis)
{
    lst->clear();
...
void serviceGUImodel::addButtons(std::map<string, int> rap)
{
...
void serviceGUImodel::addDisciplina()
{
    try {
...
void serviceGUImodel::deleteDisciplina()
{
    try {
...
void serviceGUImodel::modifyDisciplina()
{
    try {
...
void serviceGUImodel::createContract()
{
